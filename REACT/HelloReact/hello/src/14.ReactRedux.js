// redux : 상태 관리를 위한 외부 라이브러리
// npm install redux
// npm install react-redux
// 명령(action), reducer, store(상태 관리를 일원화)
// 상태 관리 흐름 : action > dispatcher > reducer > store > UI
// 모든 상태 관리를 store를 통해서 하게 됨
