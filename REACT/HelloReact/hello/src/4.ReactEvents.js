...
// 1. 유사 엘리먼트 내부에 이벤트 속성(onChane, onClick ...) 값으로 표현식(콜백함수)를 사용해 이벤트 처리
//  - 유사 엘리먼트 : JSX 내부에 HTML 엘리먼트처럼 사용하는 엘리먼트
//  - 이벤트 속성명은 on + 대문자로 시작하는 이벤트 타입

// 2. 하위 컴포넌트에 onChangeMode라는 속성을 사용해 이벤트 처리
