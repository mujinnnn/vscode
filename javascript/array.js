...
// 5) 키가 인덱스 값의 문자열이고 length키를 가진 객체

const arr1 = [1, 2, 3, 4, 5]; // 인덱스 0 ~ 4, length 5

console.log(Object.getOwnPropertyDescriptor(arr1));
...
// 유사 배열 객체 : 배열처럼 사용할 수 있는 숫자 키와 length를 가진 객체
const arrobj = {
    '0': 'orange',
    '1': 'apple',
    '2': 'banana',
...
// 배열 요소 추가/삭제
const arr8 = arr7.push(6); // 배열 끝에 요소 추가
console.log(arr7);
console.log(arr8);
const arr9 = arr7.pop(6); // 배열 끝에서 요소 제거
console.log(arr7);
console.log(arr9);
const arr10 = arr7.unshift(0); // 배열 처음에 요소 추가
console.log(arr7);
console.log(arr10); // length
const arr11 = arr7.shift(0); // 배열 처음에 요소 제거
console.log(arr7);
