...
// 1. 숫자 (number)
const num1 = 100;
const num2 = 0b0001; // 2진수
const num3 = 0o777; // 8진수
const num4 = 0xFBFF; // 16진수
const num5 = Infinity; // 양의 무한대
const num6 = -Infinity; // 음의 무한대
const num7 = NaN; // 숫자가 아니라는 숫자
...
var v; // engine, 초기화 안 되어서 엔진이 undefined로 초기화 해줌.
let l; // engine
...
// 리터럴 표기법으로 코딩을 하면 내부에서 객체생성자 표기법으로 자동변환되어 실행됨.
